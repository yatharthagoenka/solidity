...
protected:
	...
	/// Creates a @ref ParserInfo and annotates it with the current position and the
	/// given @a _description.
	void parserInfo(ErrorId _error, SourceLocation const& _location, std::string const& _description);
